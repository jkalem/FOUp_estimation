 ...
 ##This program estimate the parameters in a FOU(3) process, that is FOU(l,l,l) (with the same lambda).
...
n=length(x)
   ...
   U_Tn=function(l)
  {
    ...
    esp_dens=og^2*gamma(2*Hg+1)*sin(Hg*pi)*abs(j)^(5-2*Hg)/(2*pi*(l^2+j^2)^3)    
